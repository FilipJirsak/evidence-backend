...
CREATE CLASS Komentar EXTENDS V;
...
CREATE PROPERTY Akce.popis EMBEDDED Komentar (MANDATORY TRUE);
...
CREATE PROPERTY Pridel.popis EMBEDDED Komentar (MANDATORY TRUE);
CREATE PROPERTY Pridel.schvalen DATE (MANDATORY TRUE);
CREATE PROPERTY Pridel.odkaz STRING (MANDATORY TRUE);

CREATE PROPERTY Komentar.text STRING (MANDATORY TRUE);
CREATE PROPERTY Komentar.typ STRING (MANDATORY TRUE);

CREATE PROPERTY Objednavka.popis STRING (MANDATORY TRUE);
CREATE PROPERTY Objednavka.castka DECIMAL (MANDATORY TRUE);
CREATE PROPERTY Objednavka.datum DATE (MANDATORY TRUE);
...
CREATE PROPERTY Objednavka.poznamka EMBEDDED Komentar;
